        ...
        <header className="sticky top-0 z-40 bg-slate-900/80 backdrop-blur border-b border-slate-800">
          <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <button aria-label="Abrir menu" aria-controls="app-sidebar" aria-expanded={sidebarOpen} className="p-2 rounded hover:bg-slate-800 transition" onClick={() => setSidebarOpen((v) => !v)}>
            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="ghost" onClick={async () => { await fetch("/api/auth/logout", { method: "POST" }); router.push("/login"); }} aria-label="Sair" className="text-slate-300 hover:text-white">
          ...
          <div className="w-full max-w-2xl mx-auto">
            <div className="text-center mb-12">
              <div className="flex flex-col items-center justify-center mb-4">
                <Image src="/Logo.jpg" alt="Logo" width={100} height={100} className="rounded w-1/2 mr-3 mb-10" />
            ...
            <p className="text-center text-slate-400 text-sm mt-6">Os dados serão enviados com segurança para o nosso banco de dados.</p>
          </div>
        </main>
      </div>
    </div>
